...
echo -e "trust\n4\ny\n" | gpg --command-fd 0 --edit-key 7BB9B50FE8E021187914A5C09F65FBC212EC2DF8

cd $BASEDIR

# let's install this library first
$BASEDIR/composer.phar --working-dir="$BASEDIR" require "roave/composer-gpg-verify:dev-master#$LIBRARY_COMMIT" --prefer-source

# this package installation will work, because this guy knows how to do releases, and this release is signed
$BASEDIR/composer.phar --working-dir="$BASEDIR" require ocramius/package-versions:1.1.2 --prefer-source

# this commit is not signed - this command should fail
$BASEDIR/composer.phar --working-dir="$BASEDIR" require "ocramius/lazy-map:dev-master#5c77102e225d225ae2d74d5f2cc488527834b821"
